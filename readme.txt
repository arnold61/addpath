...
example:
I have some usefull programms and rexx scripts stored in a \_my\winpath directory on a stick. Now I can on any clientmachine copy the directory to the systemd and use addpath to set the path without walking through the gui. After the next reboot my tools are useable ...
